return {
    ...
    shops = {
        ...
        -- Setup for https://forum.cfx.re/t/mlo-editable-car-dealer/4912922
        luxury = {
            type = 'managed',
            job = 'cardealer',
            zone = {
            ...
            showroomVehicles = {
                ...
                --main floor
                { coords = vec4(-1262.88, -353.20, 36.18, 209.20), vehicle = 'italirsx' },
                { coords = vec4(-1266.63, -355.30, 36.18, 209.20), vehicle = 'zentorno' },
                { coords = vec4(-1270.06, -358.55, 35.91, 247.08), vehicle = 'autarch' },
                { coords = vec4(-1269.71, -363.91, 36.18, 297.12), vehicle = 'zorrusso' },

                --middle showcase
                { coords = vec4(-1256.35, -366.6, 36.17, 87.1), vehicle = 'prototipo' },

                --upstair
                { coords = vec4(-1243.26, -358.93, 39.57, 348.7), vehicle = 'tyrant' },
                { coords = vec4(-1245.61, -353.83, 39.57, 347.39), vehicle = 'entityxf' }
            }
        },
